# <img src="https://raw.githubusercontent.com/godot-mobile-plugins/godot-connection-state/main/addon/src/main/icon.png" width="28"> Contributing

Thank you for your interest in contributing to the Godot ConnectionState Plugin! This guide will help you understand the project structure, build processes, and development workflows.

---

## <img src="https://raw.githubusercontent.com/godot-mobile-plugins/godot-connection-state/main/addon/src/main/icon.png" width="24"> Table of Contents
...
## <img src="https://raw.githubusercontent.com/godot-mobile-plugins/godot-connection-state/main/addon/src/main/icon.png" width="24"> Project structure
...
## <img src="https://raw.githubusercontent.com/godot-mobile-plugins/godot-connection-state/main/addon/src/main/icon.png" width="24"> Build System Architecture
...
## <img src="https://raw.githubusercontent.com/godot-mobile-plugins/godot-connection-state/main/addon/src/main/icon.png" width="24"> Prerequisites
...
## <img src="https://raw.githubusercontent.com/godot-mobile-plugins/godot-connection-state/main/addon/src/main/icon.png" width="24"> Configuration
...
### <img src="https://raw.githubusercontent.com/godot-mobile-plugins/godot-connection-state/main/addon/src/main/icon.png" width="20"> Common Configuration
...
### <img src="https://raw.githubusercontent.com/godot-mobile-plugins/godot-connection-state/main/addon/src/main/icon.png" width="20">  Build Customization
...
### <img src="https://raw.githubusercontent.com/godot-mobile-plugins/godot-connection-state/main/addon/src/main/icon.png" width="20"> Local Configuration
...
### <img src="https://raw.githubusercontent.com/godot-mobile-plugins/godot-connection-state/main/addon/src/main/icon.png" width="20"> iOS Configuration
...
## <img src="https://raw.githubusercontent.com/godot-mobile-plugins/godot-connection-state/main/addon/src/main/icon.png" width="24"> Development Workflow

### Initial Setup

1. **Clone the repository:**
   ```bash
   git clone https://github.com/godot-mobile-plugins/godot-connection-state.git
   cd godot-connection-state
   ```
...
## <img src="https://raw.githubusercontent.com/godot-mobile-plugins/godot-connection-state/main/addon/src/main/icon.png" width="24"> Building
...
### <img src="https://raw.githubusercontent.com/godot-mobile-plugins/godot-connection-state/main/addon/src/main/icon.png" width="20"> Cross-Platform Builds
...
- **Release archive:** `release/ConnectionStatePlugin-*-v*.zip`

---

### <img src="https://raw.githubusercontent.com/godot-mobile-plugins/godot-connection-state/main/addon/src/main/icon.png" width="20"> Android Builds
...
### <img src="https://raw.githubusercontent.com/godot-mobile-plugins/godot-connection-state/main/addon/src/main/icon.png" width="20"> iOS Builds
...
- **Plugin XCFrameworks:** `ios/build/framework/ConnectionStatePlugin.debug.xcframework`, `ConnectionStatePlugin.release.xcframework`
- **Release archive:** `release/ConnectionStatePlugin-iOS-v*.zip`
...
## <img src="https://raw.githubusercontent.com/godot-mobile-plugins/godot-connection-state/main/addon/src/main/icon.png" width="24"> Code Formatting
...
## <img src="https://raw.githubusercontent.com/godot-mobile-plugins/godot-connection-state/main/addon/src/main/icon.png" width="24"> Testing
...
|------|----------|---------|
| `ConnectionStateTests.swift` | Swift | `ConnectionState` class — init, `isActiveKey`, `onThisHappened` callback, ObjC bridging, concurrency |
| `ConnectionStateLoggerTests.mm` | Objective-C++ | `connection_state_log` global — initialization, all log levels, format string handling |

The tests are compiled into the `connection_state_plugin_tests` Xcode test bundle target, which declares a dependency on the main `connection_state_plugin` static library target. The Xcode scheme used by the build system is `connection_state_plugin_tests`.
...
xcodebuild test
  ...
  -scheme connection_state_plugin_tests
...
| Concern | Detail |
|---------|--------|
| Target name | `connection_state_plugin_tests` |
| Product type | `com.apple.product-type.bundle.unit-test` |
| Scheme file | `ios/plugin.xcodeproj/xcshareddata/xcschemes/connection_state_plugin_tests.xcscheme` |
| Linked library | `libconnection_state_plugin.a` (the main plugin target) |
| Target dependency | `connection_state_plugin` (built before tests run) |
| Header search paths | `$(SRCROOT)/src`, `$(CONFIGURATION_TEMP_DIR)/connection_state_plugin.build/DerivedSources` |

#### Writing new iOS tests

Swift tests: add a new `XCTestCase` subclass to `ios/test/unit/` and register the file in the `connection_state_plugin_tests` target's Sources build phase in `project.pbxproj`.

Objective-C++ tests: add a `.mm` file to `ios/test/unit/`. Import `connection_state_logger.h` for logger access or `connection_state_plugin.h` for the plugin class. Add the file to the Sources build phase the same way.

> **Note on Godot engine classes:** `ConnectionStatePlugin` (the `Object` subclass), `connection_state_plugin_init()`, and `connection_state_plugin_deinit()` all depend on `memnew`/`memdelete` and `Engine::get_singleton()`, which are Godot engine internals unavailable in a plain XCTest host. Test those paths using GDScript integration tests via the Godot editor or the [GUT](https://github.com/bitwes/Gut) framework instead.
...
Run the demo project on an Android device or simulator directly from Godot editor or export to .apk and...
   ...
   adb logcat | grep -i ConnectionState
   ```
...
## <img src="https://raw.githubusercontent.com/godot-mobile-plugins/godot-connection-state/main/addon/src/main/icon.png" width="24"> Creating Releases
...
This creates:
- `release/ConnectionStatePlugin-Android-v*.zip`
- `release/ConnectionStatePlugin-iOS-v*.zip`
- `release/ConnectionStatePlugin-Multi-v*.zip` (combined)
...
## <img src="https://raw.githubusercontent.com/godot-mobile-plugins/godot-connection-state/main/addon/src/main/icon.png" width="24"> GitHub Actions Workflows
...
## <img src="https://raw.githubusercontent.com/godot-mobile-plugins/godot-connection-state/main/addon/src/main/icon.png" width="24"> Installation

### <img src="https://raw.githubusercontent.com/godot-mobile-plugins/godot-connection-state/main/addon/src/main/icon.png" width="20"> Installing to Demo App
...
### <img src="https://raw.githubusercontent.com/godot-mobile-plugins/godot-connection-state/main/addon/src/main/icon.png" width="20"> Installing to Your Project

```bash
# Using install script
./script/install.sh -t /path/to/your/project -z /path/to/ConnectionStatePlugin-*.zip

# Example
./script/install.sh -t ~/MyGame -z release/ConnectionStatePlugin-Multi-v6.0.zip
```

---

## <img src="https://raw.githubusercontent.com/godot-mobile-plugins/godot-connection-state/main/addon/src/main/icon.png" width="24"> Troubleshooting
...
#   ios/plugin.xcodeproj/xcshareddata/xcschemes/connection_state_plugin_tests.xcscheme
# and the test target must be listed in the targets array of project.pbxproj.
# Verify both are present:
find ios/plugin.xcodeproj -name "connection_state_plugin_tests.xcscheme"
grep "connection_state_plugin_tests" ios/plugin.xcodeproj/project.pbxproj
```

**Problem:** iOS tests fail with "module not found" or linker errors
```bash
# The test target links against libconnection_state_plugin.a.
...
```bash
# Tests that exercise ConnectionStatePlugin (the Godot Object subclass) or the
...
- Check existing [GitHub Issues](https://github.com/godot-mobile-plugins/godot-connection-state/issues)
- Check exısting [GitHub Discussions](https://github.com/godot-mobile-plugins/godot-connection-state/discussions)
- Review [Godot documentation](https://docs.godotengine.org/)

---

## <img src="https://raw.githubusercontent.com/godot-mobile-plugins/godot-connection-state/main/addon/src/main/icon.png" width="24"> Contributing Guidelines
...
## <img src="https://raw.githubusercontent.com/godot-mobile-plugins/godot-connection-state/main/addon/src/main/icon.png" width="24"> Additional Resources
